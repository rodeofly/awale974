...
(function() {
  ...
  Awale = (function() {
    function Awale() {
      ...
      ], this.camps = _ref1[0], this.score = _ref1[1];
      ...
      this.joueur_suivant = function() {
        var _ref2;
        _ref2 = [this.adversaire, this.player], this.player = _ref2[0], this.adversaire = _ref2[1];
        if (this.graphique) {
      ...
      this.prendre_les_graines = function() {
        ...
        _ref2 = [this.trous[this.pointeur], 0], main = _ref2[0], this.trous[this.pointeur] = _ref2[1];
        if (this.graphique) {
          $("#" + this.pointeur).empty();
        }
        return main;
      ...
      this.depose_une_graine = function() {
        ...
        if (this.graphique) {
          $("#" + this.pointeur).append("<div class='graine' style='top:50%;left:50%;'></div>");
      ...
      this.prenable = function(origine, gain_virtuel) {
        ...
        while (((_ref2 = this.trous[this.pointeur]) === 2 || _ref2 === 3) && (_ref3 = this.pointeur, __indexOf.call(this.camps[this.adversaire], _ref3) >= 0)) {
      ...
      this.reprendre_ses_graines = function() {
        var player, trou, _j, _k, _len, _len1, _ref2, _ref3, _results;
        _ref2 = [0, 1];
        _results = [];
        for (_j = 0, _len = _ref2.length; _j < _len; _j++) {
          player = _ref2[_j];
          _ref3 = this.camps[player];
      ...
      this.fin_de_jeu = function() {
        var config1, config2, the_end, trou, _j, _len, _ref2;
        the_end = true;
      ...
      this.jouable = function(_at_pointeur) {
        ...
        if ((_ref2 = this.pointeur, __indexOf.call(this.camps[this.player], _ref2) >= 0) && (this.trous[this.pointeur] > 0)) {
  ...
  $(function() {
    var aiLevel, awale, first_shot, on_first_shot, _ref;
    awale = new Awale();
    $("#game").append(awale.to_html());
    awale.initialiser();
    _ref = [1, true], aiLevel = _ref[0], first_shot = _ref[1];
    ...
    on_first_shot = function(trou) {
      ...
      _ref1 = __indexOf.call([1, 2, 3, 4, 5, 6], trou) >= 0 ? [0, 1] : [1, 0], awale.player = _ref1[0], awale.adversaire = _ref1[1];
    ...
    return $("#ordi").on("click", function() {
      var a, best, i, level, max, virtual_shot, _i, _len, _ref1, _ref2;
      if (first_shot) {
        on_first_shot();
      }
      _ref1 = [-50, -1], max = _ref1[0], best = _ref1[1];
      _ref2 = awale.camps[awale.player];
      ...
      virtual_shot = function(awales, ai, adversaire) {
        var clone, delta, game, index, key, new_awales, _j, _len1, _ref3, _ref4;
        clone = function(obj) {
          var key, newInstance;
        ...
        for (key in awales) {
          ...
          for (_j = 0, _len1 = _ref3.length; _j < _len1; _j++) {
            ...
            if (game.jouable(i)) {
              ...
              if (delta > max) {
                _ref4 = [delta, parseInt(index.slice(2, 4))], max = _ref4[0], best = _ref4[1];
